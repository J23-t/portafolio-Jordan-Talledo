...
const projects = [
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/tools/600/400',
...
export const content: ContentData = {
  es: {
    ...
    summarizer: {
        ...
        subtitle: 'Pega un artículo, ensayo o cualquier texto y mi asistente de IA generará un resumen conciso con los puntos clave.',
        input: {
            title: 'Contenido a Resumir',
            label: 'Pega tu texto aquí',
            placeholder: 'Empieza a escribir o pega el contenido de un artículo aquí para obtener tu resumen...',
        },
        output: {
            title: 'Resumen Generado',
            description: 'Resultados generados por la IA',
            placeholder: 'El resumen del contenido aparecerá aquí.',
        },
        button: {
  ...
  en: {
    ...
    summarizer: {
        ...
        subtitle: 'Paste an article, essay, or any text, and my AI assistant will generate a concise summary with the key points.',
        input: {
            title: 'Content to Summarize',
            label: 'Paste your text here',
            placeholder: 'Start writing or paste the content of an article here to get your summary...',
        },
        output: {
            title: 'Generated Summary',
            description: 'Results generated by AI',
            placeholder: 'The summary of the content will appear here.',
        },
        button: {
