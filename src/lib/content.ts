...
const projects = [
    ...
    },
    {
        ...
        description_es: 'Aplicación móvil para compartir fotos y conectar con amigos, con chat en tiempo real.',
        description_en: 'Mobile app for sharing photos and connecting with friends, with real-time chat.',
...
export const content: ContentData = {
  es: {
    ...
    projects: {
        ...
        list: projects.map(p => ({...p, description: p.description_es})),
    },
    summarizer: {
        title: 'Resumidor de Contenido con IA',
        subtitle: 'Pega un artículo, URL o texto y mi asistente de IA lo resumirá, destacando los puntos clave relevantes para mis habilidades y posibles servicios.',
        input: {
            title: 'Contenido a resumir',
            label: 'Pega aquí el contenido',
            placeholder: 'Escribe o pega aquí el artículo, ensayo o texto que deseas resumir...',
        },
        output: {
            title: 'Resumen y Conclusiones Clave',
            description: 'Resultados generados por la IA',
            placeholder: 'El resumen aparecerá aquí.',
        },
        button: {
            submit: 'Generar Resumen',
            loading: 'Generando...',
        },
        error: {
    ...
    testimonials: {
        ...
        list: testimonials.map(t => ({...t, quote: t.quote_es}))
    },
    contact: {
        title: 'Contacto',
  ...
  en: {
    ...
    projects: {
        ...
        list: projects.map(p => ({...p, description: p.description_en})),
    },
    summarizer: {
        title: 'AI Content Summarizer',
        subtitle: 'Paste an article, URL, or text, and my AI assistant will summarize it, highlighting key takeaways relevant to my skills and potential services.',
        input: {
            title: 'Content to Summarize',
            label: 'Paste the content here',
            placeholder: 'Type or paste the article, essay, or text you want to summarize here...',
        },
        output: {
    ...
    testimonials: {
        ...
        list: testimonials.map(t => ({...t, quote: t.quote_en}))
    },
    contact: {
        title: 'Contact',
